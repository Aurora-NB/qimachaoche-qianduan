    ...
    >
      <el-col :span="6">
        <div class="dataset-item">
          ...
          <p v-if="row.options.length === 1" class="value">
            {{ row.roleValue }}
          </p>
          <el-select
            v-else
      ...
      <el-col :span="14">
        <div class="dataset-item">
          ...
          <p class="value">
            <overflow-tooltip
              :tooltip-options="{ popperClass: 'tooltip-content' }"
              placement="top"
            >
              ...
              <span slot="default" class="toolContent">{{
                row.datasetData
                  ? Object.values(row.datasetData[row.roleValue]).join(", ")
                  : ""
              }}</span>
            </overflow-tooltip>
          </p>
