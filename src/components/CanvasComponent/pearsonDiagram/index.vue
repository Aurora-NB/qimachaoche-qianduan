    ...
    <div class="flex flex-row space-between flex-center correlation-title">
      <div class="flex flex-row flex-center">
        ...
        >
          <div class="flex flex-row flex-end title-filter-title">
            <i
              class="el-icon-close selection-close"
              @click.stop="showTransferDialog = false"
            />
          </div>
          <transfer
            v-show="showTransferDialog"
      ...
      <div class="flex flex-row flex-center correlation-operations">
        ...
        <icon-hover-and-active
          :active-url="
            require('@/components/CanvasComponent/pearsonDiagram/icons/sortby_click.png')
          "
          :class-name="'img-wrapper'"
          :default-url="
            require('@/components/CanvasComponent/pearsonDiagram/icons/sortby_default.png')
          "
          :hover-url="
            require('@/components/CanvasComponent/pearsonDiagram/icons/sortby_hover.png')
          "
